...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 ">
                                    <input type="password" class="form-control input-lg" name="password" placeholder="Password" name="password" required autocomplete="new-password">
                                </div>
                                <div class="form-group col-md-12 ">
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2023 Copyright Nugraha by
                <a class="text-primary" href="#" target="_blank">Nugraha</a>.
            </p>
        </div>
    </div>
</body>
